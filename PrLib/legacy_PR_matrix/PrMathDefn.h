...
#define PR_EPSILON         0.00001f
#define PR_COS_THRESHHOLD ( 1.0f - PR_EPSILON )

#define PR_THOUSAND        1000
#define PR_MILLION         ( PR_THOUSAND*PR_THOUSAND )
#define PR_BILLION         ( PR_MILLION*PR_THOUSAND )

#define PR_LB_TO_KG        ( 0.45359237f ) //=( 1.0 / 2.2046226 )
#define PR_INCH_TO_METER   ( 0.0254f )

#define PR_GRAVITY_CONSTANT ( 9.81f )
